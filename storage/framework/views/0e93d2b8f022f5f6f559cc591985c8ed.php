...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/arte_en_la_actualidad.css')); ?>">
    ...
    <div class="Grid">
        ...
        <section class="tipos">
            <div class="decoracion">
                <img src="<?php echo e(asset('img/imgen digital.png')); ?>" alt="arte digital">
                <h3>Arte digital</h3>
                <p>Uso de herramientas tecnológicas, software y plataformas virtuales para crear obras.</p>
            </div>

            <div class="decoracion">
                <img src="<?php echo e(asset('img/Arte urbano.png')); ?>" alt="arte urbano">
                <h3>Arte urbano</h3>
                <p>Incluye grafitis, murales y expresiones visuales en espacios públicos.</p>
            </div>

            <div class="decoracion">
                <img src="<?php echo e(asset('img/arte_musical.jpg')); ?>" alt="arte audiovisual">
            ...
            <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active" data-bs-interval="10000">
                        <img src="<?php echo e(asset('img/cueva_fondo_origenes.jpg')); ?>" class="d-block w-100" alt="">
                    </div>

                    <div class="carousel-item" data-bs-interval="2000">
                        <img src="<?php echo e(asset('img/escultura de roma.jpg')); ?>" class="d-block w-100" alt="">
                    </div>

                    <div class="carousel-item">
                        <img src="<?php echo e(asset('img/Monna Lisa.jpg')); ?>" class="d-block w-100" alt="">
                    </div>

                    <div class="carousel-item">
                        <img src="<?php echo e(asset('img/Captura de pantalla 2026-02-20 094631.jpg')); ?>" class="d-block w-100" alt="">
                    </div>

                    <div class="carousel-item">
                        <img src="<?php echo e(asset('img/actualidad.jpg')); ?>" class="d-block w-100" alt="">
                    </div>
...
</html><?php /**PATH C:\xampp\htdocs\copia\resources\views/content/arte_en_la_actualidad.blade.php ENDPATH**/ ?>