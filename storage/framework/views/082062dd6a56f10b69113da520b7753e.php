...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/que_se_puede_considerar_arte.css')); ?>">
            ...
            <div class="accordion" id="accordionConceptual">
                ...
                <div class="accordion-item">
                    ...
                    <div id="conceptualThree" class="accordion-collapse collapse">
                        <div class="accordion-body">
                            <div class="tarjeta">
                                <img src="<?php echo e(asset('img/Captura de pantalla 2026-02-20 094610.jpg')); ?>" alt="Arte conceptual">
            ...
            <div class="accordion" id="accordionAbstracto">
                ...
                <div class="accordion-item">
                    ...
                    <div id="abstractoThree" class="accordion-collapse collapse">
                        <div class="accordion-body">
                            <div class="tarjeta">
                                <img src="<?php echo e(asset('img/Captura de pantalla 2026-02-20 094631.jpg')); ?>" alt="Arte abstracto">
                                <p class="ejemplo">
...
</html><?php /**PATH C:\xampp\htdocs\api_arte\resources\views/content/que_se_puede_considerar_arte.blade.php ENDPATH**/ ?>